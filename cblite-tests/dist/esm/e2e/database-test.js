...
export class DatabaseTests extends TestCase {
    ...
    async testDatabaseProperties() {
        ...
        try {
            const dbPath = await ((_a = this.database) === null || _a === void 0 ? void 0 : _a.getPath());
            const dbName = this.databaseName;
            const name = (_b = this.database) === null || _b === void 0 ? void 0 : _b.getName();
    ...
    async testSaveSameDocTwice() {
        ...
        try {
            ...
            await ((_a = this.database) === null || _a === void 0 ? void 0 : _a.save(docId));
            const docSeq2 = await ((_b = this.database) === null || _b === void 0 ? void 0 : _b.getDocument('doc1'));
    ...
    async testCreateAndUpdateMutableDoc() {
        ...
        try {
            ...
            await ((_b = this.database) === null || _b === void 0 ? void 0 : _b.save(doc));
            count = await this.getDocumentCount();
            assert.equal(1, count);
            doc.setInt('age', 56);
            await ((_c = this.database) === null || _c === void 0 ? void 0 : _c.save(doc));
            count = await this.getDocumentCount();
            assert.equal(1, count);
            //validate saves worked
            const updatedDoc = await ((_d = this.database) === null || _d === void 0 ? void 0 : _d.getDocument('doc1'));
    ...
    async testPerformMaintenanceCompact() {
        ...
        try {
            ...
            for (const doc of docs) {
                const dbDoc = await ((_b = this.database) === null || _b === void 0 ? void 0 : _b.getDocument(doc.getId()));
                ...
                await ((_c = this.database) === null || _c === void 0 ? void 0 : _c.save(mutableDoc));
            }
            ...
            //compact
            await ((_d = this.database) === null || _d === void 0 ? void 0 : _d.performMaintenance(MaintenanceType.COMPACT));
            //delete all the docs
            for (const doc of docs) {
                await ((_e = this.database) === null || _e === void 0 ? void 0 : _e.deleteDocument(doc));
            }
            ...
            //compact again
            await ((_f = this.database) === null || _f === void 0 ? void 0 : _f.performMaintenance(MaintenanceType.COMPACT));
